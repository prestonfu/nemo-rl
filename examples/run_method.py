...
from nemo_rl.algorithms.method import MasterConfig, method_train, setup
...
def parse_args() -> tuple[argparse.Namespace, list[str]]:
    ...
    parser = argparse.ArgumentParser(
        description="Run method training with configuration"
    )
    parser.add_argument(
...
def main() -> None:
    ...
    if not args.config:
        args.config = os.path.join(
            os.path.dirname(__file__), "configs", "method_math.yaml"
        )
